...
async def run_application_phase(page: Page, adapter: any, vault: dict, target_platform: str):
    ...
    profile_data["ollama_base_url"] = "http://127.0.0.1:11434"
...
async def main():
    ...
    target_platforms = ["internshala"] 
    
    # Define platform entry search points (Kept exactly as you laid it out)
    search_urls = {
        "internshala": "https://internshala.com/internships/work-from-home-full-stack-development-internships-in-noida/fast-response-true/",
